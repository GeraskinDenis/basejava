...
public class SortedArrayStorageTest extends AbstractArrayStorageTest {
    ...
    public void deleteFirst() {
        ...
        expected[0] = RESUME_UUID_2;
        expected[1] = RESUME_UUID_3;
    ...
    public void saveAtStart() {
        Resume resume_uuid_0 = new Resume("uuid0");
        Resume[] expected = new Resume[4];
        expected[0] = resume_uuid_0;
        expected[1] = RESUME_UUID_1;
        expected[2] = RESUME_UUID_2;
        expected[3] = RESUME_UUID_3;

        storage.save(resume_uuid_0);
        Resume[] actuals = Arrays.copyOf(storage.storage, 4);
        Assert.assertArrayEquals(expected, actuals);
        Assert.assertEquals("The number of elements in storage is different!", 4, storage.size);
    }
    ...
    public void getIndexNotExistUUID() {
        Assert.assertTrue(storage.getIndex(NOT_EXIST_UUID) < 0);
    }
}